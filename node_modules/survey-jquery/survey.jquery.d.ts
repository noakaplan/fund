/*Type definitions for Survey JavaScript library v0.12.19
...
export declare class SurveyQuestionMultipleText extends SurveyQuestionElementBase {
    ...
    render(): JSX.Element;
    protected renderRow(key: string, items: Array<MultipleTextItemModel>, cssClasses: any): JSX.Element;
...
export declare class PanelModelBase extends Base implements IConditionRunner, ILocalizableOwner {
        ...
        /**
            ...
            */
        visible: boolean;
        panelVisibilityChanged(panel: Object, visibility: boolean): void;
        protected onVisibleChanged(): void;
        /**
